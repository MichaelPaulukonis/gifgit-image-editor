...
var flipHorizRadio = document.getElementById("flipHorizRadio");
var flipVertRadio = document.getElementById("flipVertRadio");
...
workspaceContainerDiv.addEventListener("dblclick", function(e){
	...
	setMouseCoordinates(e, workspaceContainerDiv);
...
function addFlipEdit(){
	...
	let flipdir = "horizontal";

	if(flipHorizRadio.checked){
		flipdir = "horizontal";
	}
	
	if(flipVertRadio.checked){
		flipdir = "vertical";
	}
	...
	*/
	...
	flipEditEntry.direction = flipdir;
	...
	// Use below for selection area flipping
	// addFlippedActiveSelectionArea(flipdir);

	applyEditHistory();
	
	// flipHorizRadio.checked = true;
